...
public class GameScreen2Win implements Screen{
	...
	public GameScreen2Win(crazyFlappy juego) {
		super();
		this.juego = juego;
	...
	public void render(float delta) {
		...
		juego.fuente.draw(juego.spriteBatch, "Preparad@ para el modo EXPERTO?", Constants.SCREEN_HEIGHT /2, 170);
		juego.fuente.draw(juego.spriteBatch, "Tu puntuacion: " + juego.monedasRecojidas
				, Constants.SCREEN_HEIGHT/2, 150);
		juego.fuente.draw(juego.spriteBatch, "PULSA 3 para el MODO EXPERTO", Constants.SCREEN_HEIGHT /2, 130);
